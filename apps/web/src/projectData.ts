...
export const copy = {
  ru: {
    ...
    auth: {
      ...
      tenantTitle:
        "Введите телефон, закреплённый за договором. Код придёт в подключённый канал.",
      tenantFirstTimeTitle: "Подключите мессенджер",
      tenantFirstTimeText:
        "Telegram: поделитесь своим контактом. VK: отправьте код привязки от управляющего или из кабинета.",
      ...
      resetHint:
        "Введите рабочий email. Код придёт в привязанный Telegram или VK.",
      ...
      accessNoteHint:
        "Используйте учетные данные, выданные администратором платформы.",
    },
    topbar: {
      logout: "Выйти",
      refresh: "Обновить",
    ...
    hints: {
      ...
      noData: "Нет данных",
      availableUnits:
        "Для нового договора доступны только помещения без активного контракта.",
  ...
  en: {
    ...
    auth: {
      title:
        "CRM, Service Desk, and property control in one operating surface.",
      description:
      ...
      tenantTitle:
        "Enter the phone linked to the lease. The code will arrive through the connected channel.",
      tenantFirstTimeTitle: "First tenant sign-in",
      tenantFirstTimeText:
        "Bind Telegram or VK first: open the bot, send the phone number from the lease, then return here and request the code.",
      ...
      resetHint:
        "Enter your work email. The code will arrive in the linked Telegram or VK.",
      ...
      accessNoteHint:
        "Use the credentials issued by the platform administrator.",
    },
    topbar: {
      logout: "Log out",
      refresh: "Refresh",
    ...
    hints: {
      ...
      noData: "No data",
      availableUnits:
        "Only units without an active contract are available for a new lease.",
