...
export const copy = {
  ru: {
    ...
    auth: {
      ...
      tenantFirstTimeTitle: "Подключите мессенджер",
      tenantFirstTimeText: "Telegram: поделитесь своим контактом. VK: отправьте код привязки от управляющего или из кабинета.",
